        ...
        return `
            ...
            <body class="bg-gray-100 font-sans">
                <div class="invoice-container mx-auto bg-white shadow-lg print:shadow-none">
                    ...
                    <div class="print-invoice-btn no-print fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg cursor-pointer print:hidden">
