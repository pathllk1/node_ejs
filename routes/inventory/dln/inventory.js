...
const controller = require('../../../controllers/turso/inventory/dln/inventory');
...
// API Routes: Bills (Delivery Notes)
...
// Convenience alias
router.get('/api/delivery-notes', verifyFirmAccess, controller.getAllDeliveryNotes);
