...
const controller = require('../../../controllers/turso/inventory/dnt/inventory');
...
// Convenience alias
router.get('/api/debit-notes', verifyFirmAccess, controller.getAllDebitNotes);
